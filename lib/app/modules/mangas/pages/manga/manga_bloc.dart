...
class MangaBloc extends Disposable {
  ...
  final BehaviorSubject<List<Capitulo>> dados = BehaviorSubject<List<Capitulo>>();
  ...
  void pesquisar(res){
    dados.add(null);
    List<Capitulo> pesquisa = capitulos.where((t) => t.titulo.toLowerCase().contains(res.toLowerCase())).toList();
